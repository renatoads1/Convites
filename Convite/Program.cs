...
.AddCookie(options =>
{
    ...
    options.Cookie.SecurePolicy = CookieSecurePolicy.Always;  // Requer HTTPS (em produção)
    options.Cookie.SameSite = SameSiteMode.None; // Evita problemas com requisições entre sites
